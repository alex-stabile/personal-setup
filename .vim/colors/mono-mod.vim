...
let s:white       = { "gui": "#F8F8F2", "cterm": "252" } " was #E8E8E3
let s:white2      = { "gui": "#d8d8d3", "cterm": "250" }
let s:white3      = { "gui": "#acaca8", "cterm": "250" } " me
...
let s:purple      = { "gui": "#ac80ff", "cterm": "141" } " was ae81ff
...
call s:h("StatusLine",    { "fg": s:white3,   "bg": s:black,        "format": "reverse" })
...
" Vim-JS Overrides
" For highlight groups see: https://github.com/yuezk/vim-js/blob/master/syntax/javascript.vim
call s:h("jsMethod",         { "fg": s:green }) " e.g. render() on class object
call s:h("jsVariableType",      { "fg": s:aqua,   "format": "italic" })
call s:h("jsObjectBraces",      { "fg": s:white })
call s:h("jsDestructuringBraces",      { "fg": s:white })
call s:h("jsObjectKey",         { "fg": s:yellow })
call s:h("jsImport",         { "fg": s:pink })
call s:h("jsExport",         { "fg": s:pink })
call s:h("jsComment",       { "fg": s:warmgrey })
" arr.map()
" -------~~
call s:h("jsFunctionCall",       { "fg": s:aqua })
call s:h("jsParens",       { "fg": s:white })
call s:h("jsBraces",       { "fg": s:white })
call s:h("jsBrackets",       { "fg": s:white })
call s:h("jsObjectDestructuringKey",          { "fg": s:orange, "format": "italic" })
call s:h("jsStatic",       { "fg": s:pink })
call s:h("jsMethod",         { "fg": s:green }) " e.g. render() on class object
call s:h("jsArgIdentifier",          { "fg": s:orange, "format": "italic" })
call s:h("jsFunction",          { "fg": s:aqua, "format": "italic" })
call s:h("jsClass",          { "fg": s:aqua, "format": "italic" })
call s:h("jsClassProp",         { "fg": s:green })

" JSX Overrides
" For highlight groups see: https://github.com/MaxMEllon/vim-jsx-pretty#syntax-group-list
...
" Flow
call s:h("jsFlowParameter",       { "fg": s:purple, "format": "italic" })
...
call s:h("rubyInstanceVariable",        { "fg": s:orange })
